...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "travelapproval/test/integration/FirstJourney",
    "travelapproval/test/integration/TravelRequestsListJourney",
    "travelapproval/test/integration/TravelRequestsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
